...
import type {
  ...
  TypedResponse,
  ValidationTargets,
} from 'jsr:@hono/hono@4.8.2'
import { validator } from 'jsr:@hono/hono@4.8.2/validator'
import type * as v3 from 'npm:zod'
import type { ZodSafeParseResult as v4ZodSafeParseResult } from 'npm:zod/v4'
import type * as v4 from 'npm:zod/v4/core'
